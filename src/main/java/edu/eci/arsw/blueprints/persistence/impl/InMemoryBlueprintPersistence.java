...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence{
    ...
    public InMemoryBlueprintPersistence() {
        ...
        pts=new Point[]{new Point(15, 25), new Point(23, 15)};
        bp=new Blueprint("cesar", "theBestPlan", pts);
        blueprints.put(new Tuple<>(bp.getAuthor(),bp.getName()), bp);

        pts=new Point[]{new Point(12, 16), new Point(14, 16)};
        bp=new Blueprint("cesar", "aNicePlan", pts);
        blueprints.put(new Tuple<>(bp.getAuthor(),bp.getName()), bp);

        pts=new Point[]{new Point(16, 12), new Point(16, 14)};
        bp=new Blueprint("miguel", "notGoodplan", pts);
        blueprints.put(new Tuple<>(bp.getAuthor(),bp.getName()), bp);
